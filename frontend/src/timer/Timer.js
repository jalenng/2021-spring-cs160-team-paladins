...
export default class extends React.Component {
    ...
    componentDidMount() {
        ...
        timer.eventSystem.on("update", (event, status) => {
        ...
        return (
            <div>
                <Stack vertical tokens={{ childrenGap: 8 }} horizontalAlign="center">
                    ...
                    {/* Timer controls */}
                    <TimerControls
                        mainButtonTooltip={this.state.isPaused ? "Start" : "Pause"}
                        mainButtonDisabled={this.state.disableButtons}
                        mainButtonIconName={this.state.isPaused ? "Play" : "Pause"}
                        secondaryButtonDisabled={this.state.disableButtons}
                    />
